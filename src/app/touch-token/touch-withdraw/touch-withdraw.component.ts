...
@Component({
  selector: 'touch-withdraw',
  styleUrls: ['./touch-withdraw.component.css'],
  templateUrl: './touch-withdraw.component.html'
})
export class TouchWithdrawComponent implements OnInit {
  public wallet: any = {};
  public bodydata: any = {};
  public referralType;
  public records;
  ...
  getWithdrawl(amount) {
    ...
    if ((amount.value != '')) {
      if (this.wallet['balance'] < addfundamount) {
        ...
        this.api.post('/secure/touch-withdrawal', obj).subscribe(data => {
