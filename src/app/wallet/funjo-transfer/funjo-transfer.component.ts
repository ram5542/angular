...
@Component({
  selector: 'app-funjo-transfer',
  templateUrl: './funjo-transfer.component.html',
  styleUrls: ['./funjo-transfer.component.css']
})
export class FunjoTransferComponent implements OnInit {
