...
@Component({
  selector: 'app-level-wallet',
  templateUrl: './level-wallet.component.html',
  styleUrls: ['./level-wallet.component.css']
})
export class LevelWalletComponent implements OnInit {
  public bodydata: any = {};
  public tableview = {};
  public records;
  public start;
