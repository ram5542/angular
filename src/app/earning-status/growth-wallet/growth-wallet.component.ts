...
@Component({
  selector: 'app-growth-wallet',
  templateUrl: './growth-wallet.component.html',
  styleUrls: ['./growth-wallet.component.css']
})
export class GrowthWalletComponent implements OnInit {
  public bodydata: any = {};
  public tableview = {};
  public records;
  public start;
